...
from models_TC.Swin_poolformer_Unet.shuffleblock import Basicunit_shuffle
from models_TC.Swin_swinBTS_Unet.PatchPartition import PatchEmbed3D
from models_TC.Swin_swinBTS_Unet.BasicLayer import BasicLayer, PatchExpand_Up, Basiclayer_up, \
    FinalPatchExpand_X4, FinalPatchExpand_X41, SwinTransformerBlock3D
from models_TC.Swin_swinBTS_Unet.BasicLayer_Res import Basiclayer_Bottleneck
...
if __name__ == '__main__':
    ...
    print(f"total number of trainable parameters {count_parameters(swinunetr())}")
    a= swinunetr()(a)
    print(a.shape)